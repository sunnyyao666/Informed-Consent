...
public class OrganizationProjectController {
    ...
    @PostMapping("/project")
    public MyResponse createProject(@RequestParam String organization, @RequestParam Integer pid, @RequestParam String name, @RequestParam String time, @RequestParam String purpose, @RequestParam String schedule, @RequestParam(name = "data", required = false) List<String> fields, HttpServletResponse response, HttpServletRequest request) {
    ...
    public MyResponse savedProject(@RequestParam String organization, @RequestParam Integer pid, @RequestParam String name, @RequestParam String time, @RequestParam String purpose, @RequestParam String schedule, @RequestParam(name = "data", required = false) List<String> fields, HttpServletResponse response, HttpServletRequest request) {
        if (null == pid) {
